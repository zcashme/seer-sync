...
// A Unified *Incoming* Viewing Key (uivk1…). Unlike a UFVK it carries no
// nullifier or outgoing keys, so this syncs incoming notes and their balances
// only — no spend detection, no sent-output recovery.
