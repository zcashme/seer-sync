...
use seer_sync::{keys, BlockHeight, Network};
...
async fn main() -> Result<()> {
    ...
    // 1. Parse the view key into the pool IVKs/FVKs the scanner trial-decrypts
    //    with. (`from_ufvk_str` reports decode failures as a plain String.)
