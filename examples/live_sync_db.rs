...
async fn main() -> Result<()> {
    ...
    let view_key = ViewKey::decode(&Network::MainNetwork, UFVK).map_err(|e| anyhow!(e))?;
    ...
    let final_height = seer_sync::scan_to_tip(&view_key, &Network::MainNetwork, BIRTHDAY, &db, client, |h| {
